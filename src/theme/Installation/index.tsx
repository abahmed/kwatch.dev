        ...
        <div className="row">
          <div className="col col--10 col--offset-1">
            <div className={styles.headline}>
              ...
              <CodeSnippet
                language="bash"
                code="curl  -L https://raw.githubusercontent.com/abahmed/kwatch/v0.8.5/deploy/config.yaml -o config.yaml"
              />
              ...
              <CodeSnippet
                language="bash"
                code="kubectl apply -f https://raw.githubusercontent.com/abahmed/kwatch/v0.8.5/deploy/deploy.yaml"
              />
            </div>
          </div>
        </div>
