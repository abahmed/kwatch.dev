...
description: Configure Dingtalk alerts with kwatch using the current provider catalog.
keywords: [kwatch, Kubernetes alerts, Dingtalk, notification channel]
---

# Dingtalk alerts

Use **Dingtalk** when you want kwatch incidents delivered to this channel. This page is generated from the current provider catalog and lists every field accepted by the installed release.
