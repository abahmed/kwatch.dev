...
description: kwatch v0.5.0 released — new features including AI-powered crash analysis, Rocket.Chat support, and configurable severity levels for Kubernetes alerts
