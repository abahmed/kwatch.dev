---
title: IFTTT alerts
description: Configure IFTTT alerts with kwatch using the current provider catalog.
keywords: [kwatch, Kubernetes alerts, IFTTT, notification channel]
---

# IFTTT alerts

Use **IFTTT** when you want kwatch incidents delivered to this channel. This page is generated from the current provider catalog and lists every field accepted by the installed release.
