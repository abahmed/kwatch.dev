...
description: Configure Pushbullet alerts with kwatch using the current provider catalog.
keywords: [kwatch, Kubernetes alerts, Pushbullet, notification channel]
---

# Pushbullet alerts

Use **Pushbullet** when you want kwatch incidents delivered to this channel. This page is generated from the current provider catalog and lists every field accepted by the installed release.
