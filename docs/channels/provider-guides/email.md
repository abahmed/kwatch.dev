---
title: Email alerts
description: Configure Email alerts with kwatch using the current provider catalog.
keywords: [kwatch, Kubernetes alerts, Email, notification channel]
---

# Email alerts

Use **Email** when you want kwatch incidents delivered to this channel. This page is generated from the current provider catalog and lists every field accepted by the installed release.
