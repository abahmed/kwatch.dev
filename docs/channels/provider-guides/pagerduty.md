...
description: Configure PagerDuty alerts with kwatch using the current provider catalog.
keywords: [kwatch, Kubernetes alerts, PagerDuty, notification channel]
---

# PagerDuty alerts

Use **PagerDuty** when you want kwatch incidents delivered to this channel. This page is generated from the current provider catalog and lists every field accepted by the installed release.
