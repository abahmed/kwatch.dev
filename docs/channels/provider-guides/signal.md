---
title: Signal alerts
description: Configure Signal alerts with kwatch using the current provider catalog.
keywords: [kwatch, Kubernetes alerts, Signal, notification channel]
---

# Signal alerts

Use **Signal** when you want kwatch incidents delivered to this channel. This page is generated from the current provider catalog and lists every field accepted by the installed release.
