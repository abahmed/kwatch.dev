...
description: Monitor Kubernetes Persistent Volume (PV) disk usage with kwatch — get alerts when PVCs approach capacity, with Slack and Discord notifications
...
For more configurations check [here](/docs/general-configuration#-pvc-monitor)
