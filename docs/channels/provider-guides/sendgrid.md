...
description: Configure SendGrid alerts with kwatch using the current provider catalog.
keywords: [kwatch, Kubernetes alerts, SendGrid, notification channel]
---

# SendGrid alerts

Use **SendGrid** when you want kwatch incidents delivered to this channel. This page is generated from the current provider catalog and lists every field accepted by the installed release.
