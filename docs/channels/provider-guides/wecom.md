---
title: WeCom alerts
description: Configure WeCom alerts with kwatch using the current provider catalog.
keywords: [kwatch, Kubernetes alerts, WeCom, notification channel]
---

# WeCom alerts

Use **WeCom** when you want kwatch incidents delivered to this channel. This page is generated from the current provider catalog and lists every field accepted by the installed release.
