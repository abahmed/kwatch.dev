---
title: GitLab alerts
description: Configure GitLab alerts with kwatch using the current provider catalog.
keywords: [kwatch, Kubernetes alerts, GitLab, notification channel]
---

# GitLab alerts

Use **GitLab** when you want kwatch incidents delivered to this channel. This page is generated from the current provider catalog and lists every field accepted by the installed release.
